    ...
    >
        ...
        {renaming ? (
          ...
          >
            <Input
              ...
              value={title}
            />
            <button className="text-sm font-semibold text-charcoal" type="submit">
          ...
          <NextLink className="block" href={`/documents/${document.id}`}>
      ...
      {!renaming ? (
        <div className="flex items-center gap-1">
          ...
          >
            <IconArrowUpRight size={19} stroke={1.8} />
          </NextLink>
          {editable ? (
